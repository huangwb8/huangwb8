...
- <a href="https://github.com/huangwb8/VibeNotification/commit/1b7e62d8f366de46ec4de5865bebbfc183cff728">1b7e62d</a>: fix(debounce): 强化后台去重与配置诊断

- 改进后台防抖进程的状态传递与并发去重行为
- 完善 Codex 事件识别、诊断输出和官方钩子说明
- 扩充核心流程、CLI 与解析器回归测试
